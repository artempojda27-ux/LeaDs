...
${leadsList}`;
  ...
  try {
    ...
    // content[0] не всегда текст — если Claude включает "размышление"
    // перед ответом, первым блоком идёт {type:"thinking"}, а настоящий
    // ответ — в следующем {type:"text"}. Ищем именно текстовый блок.
